export default {
  ...
  addLandmark: {
    searchPlaceholder: "Search for landmarks...",
    filterAll: "All",
    filterVerified: "Verified",
    filterPending: "Pending",
    LandmarksTitle: "Landmarks on Map",
    pendingLandmarksTitle: "Landmarks Pending Review",
    noPendingLandmarks: "No landmarks pending review in this area",
    noVerifiedLandmarks: "No verified landmarks in this area",
    noLandmarks: "No landmarks in this area",
    ...
    landmarkTitlePlaceholder: "Landmark Name",
    ...
    confirm: "Confirm",
    reject: "Reject",
    helpVerifyLandmarks: "Help Verify Landmarks",
    verifyNearbyLandmarks: "Verify Nearby Landmarks",
    accurateQuestion: "Is this landmark present and correctly located?",
    ...
    error: "An error occurred while adding the landmark",
    success: "Success", // ← أضف هذا السطر
    noNearbyLandmarks: "No nearby landmarks",
    common: {
      ok: "OK",
      cancel: "Cancel",
    ...
    errors: {
      ...
      nearbyOnly: "You can only interact with landmarks in your current area",
      duplicateLocation: "Location Occupied",
      duplicateName: "Duplicate Landmark Name",
      landmarkExistsAtLocation: "There is already a landmark at this location",
      landmarkNameExistsNearby: "A landmark with this name already exists nearby",
      tooFar: "Too Far",
      landmarkTooFarFromLocation: "You can only add landmarks within {radius} meters from your location",
      enableLocation: "Please enable location services to add landmarks",
      locationRequired: "Location Required",
      locationOccupied: "Location Occupied",
      chooseDifferentLocation: "Please choose a different location",
      duplicateLandmark: "Landmark already exists at this location or with this name",
      failedToAddLandmark: "Failed to add landmark",
    ...
    votedYes: "Voted Yes",
    votedNo: "Voted No",
    tribalReviewNeeded: "Tribal Review Needed",
    disputeDescription: "This landmark has conflicting votes and requires review by the tribal council.",
    deleteLandmark: "Delete Landmark",
    close: "Close",
    verificationRequirements: "Verification Requirements",
    totalWeightRequirement: "Total Weight ≥ 5.6",
    approvalRateRequirement: "Approval Rate ≥ 80%",
    verifiedStatus: "✓ Verified - All requirements met",
  },
  addRoute: {
    route: "Route",
